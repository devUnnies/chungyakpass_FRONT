...
/* 액션 타입 */
// 다자녀 아파트 분양정보 보내기
export const RES_MULTICHILD_APTNUM_POST = 'RES_MULTICHILD_APTNUM_POST';
export const RES_MULTICHILD_APTNUM_POST_SUCCESS =
    'RES_MULTICHILD_APTNUM_POST_SUCCESS';
export const RES_MULTICHILD_APTNUM_POST_ERROR =
