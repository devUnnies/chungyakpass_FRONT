        ...
        <>
            ...
            <div className="personalRulesContainer">
                <p className="personalRulesText">
                    ...
                    <br />
                    <br />○ 이 개인정보처리방침은 2021년 10월 18일부터
                    적용됩니다.
                </p>

                <h5>제1조(개인정보의 처리 목적)</h5>
                <p className="personalRulesText">
                    청약패스('chungyakpass.com'이하 '청약패스')은(는) 다음의
                    목적을 위하여 개인정보를 처리합니다.
                    <br />
                    <br />
                    ...
                    이행할 예정입니다.
                    <br />
                    1. 홈페이지 회원가입 및 관리 회원 가입의사 확인, 회원자격
                ...
                <p className="personalRulesText">
                    ① 청약패스은(는) 법령에 따른 개인정보 보유·이용기간 또는
                    정보주체로부터 개인정보를 수집 시에 동의받은 개인정보
                    보유·이용기간 내에서 개인정보를 처리·보유합니다.
                    <br />② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.
                    <br />
                    1. 홈페이지 회원가입 및 관리 홈페이지 회원가입 및 관리와
                    관련한 개인정보는 수집.이용에 관한 동의일로부터 3년까지 위
                    이용목적을 위하여 보유.이용됩니다. 보유근거 : 회원이어야
                    서비스 이용이 가능하여 3년 보유합니다.
                    <br />
                    2. 재화 또는 서비스 제공 재화 또는 서비스 제공와 관련한
                    개인정보는 수집.이용에 관한 동의일로부터3년까지 위
                    이용목적을 위하여 보유.이용됩니다. 보유근거 : 서비스를
                    제공하는 데 있어 사용자의 개인정보가 필요하여 3년
                    보유합니다.
                </p>
                <h5>제3조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)</h5>
                <p className="personalRulesText">
                    ① 정보주체는 청약패스에 대해 언제든지 개인정보
                    열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
                    <br />
                    ② 제1항에 따른 권리 행사는청약패스에 대해 「개인정보
                    보호법」 시행령 제41조제1항에 따라 서면, 전자우편,
                    모사전송(FAX) 등을 통하여 하실 수 있으며 청약패스은(는) 이에
                    대해 지체 없이 조치하겠습니다.
                    <br />
                    ...
                    없습니다.
                    <br />⑥ 청약패스은(는) 정보주체 권리에 따른 열람의 요구,
                    정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가
                    본인이거나 정당한 대리인인지를 확인합니다.
                </p>
                <h5>제4조(처리하는 개인정보의 항목 작성)</h5>
                <p className="personalRulesText">
                    ① 청약패스은(는) 다음의 개인정보 항목을 처리하고 있습니다.
                    <br />
                    <br />
                    1 홈페이지 회원가입 및 관리
                    <br />
                    ...
                    <br />
                    2 재화 또는 서비스 제공
                    <br />- 필수항목 : 생년월일, 이름, 결혼여부, 은행계좌정보
                </p>

                <h5>제5조(개인정보의 파기)</h5>
                <p className="personalRulesText">
                    ① 청약패스 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
                    ...
                    1. 파기절차
                    <br />
                    - 청약패스 은(는) 파기 사유가 발생한 개인정보를 선정하고,
                    청약패스 의 개인정보 보호책임자의 승인을 받아 개인정보를
                    파기합니다.
                    <br />
                    2. 파기방법
                    <br />- 전자적 파일 형태의 정보는 기록을 재생할 수 없는
                    기술적 방법을 사용합니다
                </p>

                <h5>제6조(개인정보의 안전성 확보 조치)</h5>
                <p className="personalRulesText">
                    청약패스 은(는) 개인정보의 안전성 확보를 위해 다음과 같은
                    조치를 취하고 있습니다.
                    <br />
                    1. 정기적인 자체 감사 실시
                    <br />
                    ...
                    4. 해킹 등에 대비한 기술적 대책
                    <br />
                    - 청약패스('청약패스')은 해킹이나 컴퓨터 바이러스 등에 의한
                    ...
                    <br />
                    9. 비인가자에 대한 출입 통제
                    <br />- 개인정보를 보관하고 있는 물리적 보관 장소를 별도로
                ...
                <h5>제10조(개인정보 처리방침 변경)</h5>
                <p className="personalRulesText">
                    ① 이 개인정보처리방침은 2021년 10월 18일부터 적용됩니다.
                </p>
            </div>
            <TopButton />
        </>
