        ...
        <form onSubmit={onSubmitEdit} className="modifyForm">
          <div>
                ...
                <div className="isSoldierContainer">
                  <span className="subTitle">장기복무 여부</span>
                    ...
                    <input
                      ...
                      onChange={onEditChange}
                      value="y"
                      checked={edited.soldierYn === "y" ? true : false}
                    />
                    ...
                    <input
                      ...
                      onChange={onEditChange}
                      value="n"
                      checked={edited.soldierYn === "n" ? true : false}
                    />
            ...
            <div className="householderContainer">
              ...
              <input
                ...
                onChange={onEditChange}
                value="y"
                checked={edited.householderYn === "y" ? true : false}
                required
              />
              ...
              <input
                ...
                onChange={onEditChange}
                value="n"
                checked={edited.householderYn === "n" ? true : false}
                required
              />
          ...
          <div className="buttonWrapper">
            {/* <button onClick={onCancel} className="cancelButton"> */}
              <CloseCircleOutlined onClick={onCancel} className="cancelIcon" />
            {/* </button> */}
            {/* <button type="submit" className="submitButton"> */}
              <CheckCircleOutlined onClick={onSubmitEdit} className="submitIcon" />
            {/* </button> */}
          </div>
        </form>
      {/* </div> */}
