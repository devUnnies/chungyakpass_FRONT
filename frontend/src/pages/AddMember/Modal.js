          ...
          <div>
            ...
            <div>
              ...
              <input
                ...
                onChange={onEditChange}
                value="local"
                checked={edited.nationality === "local" ? true : false}
              />{" "}
              내국인
              <input
                type="radio"
                ...
                onChange={onEditChange}
                value="foreigner"
                checked={edited.nationality === "foreigner" ? true : false}
              />{" "}
              외국인 <br />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                onChange={onEditChange}
                value="owner"
                checked={edited.owner === "owner" ? true : false}
              />
              세대주이다
              <input
                type="radio"
                ...
                onChange={onEditChange}
                value="noneOwner"
                checked={edited.owner === "noneOwner" ? true : false}
              />
              세대주가 아니다
            </div>
            <div>
              ...
              <input
                type="radio"
                name="marriage"
                value={edited.marriage}
                onChange={onEditChange}
                value="noneMarried"
                checked={edited.marriage === "noneMarried" ? true : false}
              />
              미혼
              <input
                type="radio"
                ...
                onChange={onEditChange}
                value="married"
                checked={edited.marriage === "married" ? true : false}
              />
              기혼 <br />
            </div>
            <div>
