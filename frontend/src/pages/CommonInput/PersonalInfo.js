...
function PersonalInfo() {
    ...
    const { name, birth, nationality, soldier, owner, residence, seperation, marriage, marryDate, income, asset } = inputs; 

    const onChange = (e) => { 
        const { name, birth, owner, nationality, soldier, residence, seperation, marriage, marryDate, income, asset, value }  = e.target;
        setInputs({
          ...inputs,
          [name]: value,
          [birth]: value,
