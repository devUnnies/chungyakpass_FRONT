...
function MemberInfo() {
  ...
  const { name, birth, nationality, relationship, owner, marriage, income, asset, history } = inputs; 

  const onChange = (e) => { 
    const { name, birth, relationship, owner, marriage, income, asset, history, value }  = e.target;
    setInputs({
      ...inputs,
      [name]: value,
      [birth]: value,
