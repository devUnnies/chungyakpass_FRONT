...
import { getMultiChildKookmin } from '../../../store/actions/multiChildKookminAction';
...
const MultiChildKookminApi = ({ onSaveData }) => {
    ...
    const onClick = async () => {
        ...
        //     console.log(e);
        // }
        dispatch(getMultiChildKookmin()); // api 연결 요청.
        const data = multiChildKookminStore?.getMultiChildKookmin?.data?.data;
        console.log(JSON.stringify(data));
    };

    // useEffect(() => {
    //     // 불러오기 성공 시
    //     if (multiChildKookminStore.getMultiChildKookmin.data) {
    //         const data = multiChildKookminStore.getMultiChildKookmin.data.data;
    //         console.log(JSON.stringify(data));
    //     }
    // }, [multiChildKookminStore.getMultiChildKookmin]);
        ...
        <>
            ...
            <form className="specialSupply_form" onSubmit={handleSubmit}>
                ...
                <table className="specialKookmin_table">
                    ...
                    {/* 월평균 기준 소득 충족 여부 */}
                    {/* "공공주택특별법적용&미적용 이외의 국민주택" 은 이 부분 판단할 필요 없음 (소득 기준 미적용)*/}
                    <tr className="special_phase">
                        <td className="qulificaiton">
                            <span className="qulificaitonBox">
                                월평균 소득 기준 충족 여부
