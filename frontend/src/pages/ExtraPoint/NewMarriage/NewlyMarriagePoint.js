        ...
        <>
            <div className="point_title">
                <h3 className="point_mainTitle">
                    가점 계산
                    <span className="point_subTitle">| 신혼부부 특별공급 </span>
                </h3>
            </div>
                    ...
                    <tr className="point_phase">
                        ...
                        <td className="point_result">
                            <input
                                ...
                                value={
                                    JSON.stringify(data?.ageOfMostYoungChild) +
                                    ' ' +
                                    '점'
                                }
                                readOnly={true}
                    ...
                    <tr className="point_phase">
                        ...
                        <td className="point_result">
                            <input
                                className="aptInfoSelect"
                                value={
                                    JSON.stringify(data?.periodOfMarriaged) +
                                    ' ' +
                                    '점'
                                }
                                readOnly={true}
                    ...
                    <tr className="point_phase">
                        ...
                        <td className="point_result">
                            <input
                                className="aptInfoSelect"
                                value={
                                    JSON.stringify(data?.monthOfAverageIncome) +
                                    ' ' +
                                    '점'
                                }
                                readOnly={true}
