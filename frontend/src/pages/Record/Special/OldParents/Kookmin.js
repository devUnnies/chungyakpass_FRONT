...
const RecordDetailSpecialOldParentsKookmin = () => {
    ...
    useEffect(() => {
        ...
        const speOldParKook =
            allRecords?.verificationOfSpecialKookminPublicOldParentsResponseDtos;

        if (allRecords) {
            if (speOldParKook) {
                speOldParKook.map((content, i) => {
                    if (id === content.id) {
                        setItem(content);
                    }
                });
                        ...
                        <table className="recordsGeneralKookminInfoTable">
                            <tbody className="recordsGeneralKookminInfoTableTbody">
                                ...
                                <tr className="recordsGeneralKookminInfoTableTbodyTr">
                                    ...
                                    <td className="recordsGeneralKookminInfoTableTbodyTrTd">
                                        {item.meetOldParentSupportMore3yearsTf
                                            ? '충족'
                                            : '미충족'}
                                    </td>
                                </tr>
                                ...
                                <tr className="recordsGeneralKookminInfoTableTbodyTr">
                                    ...
                                    <td className="recordsGeneralKookminInfoTableTbodyTrTd">
                                        {item.meetMonthlyAverageIncomeTf
                                            ? '충족'
                                            : '미충족'}
                                    </td>
                                </tr>
...
export default RecordDetailSpecialOldParentsKookmin;
